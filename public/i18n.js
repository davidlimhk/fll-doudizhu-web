...
const translations = {
  'zh-TW': {
    ...
    score_select_short: '—', score_score_label: '得分', score_latest_round: '最新回合', score_cancel: '取消',
    ...
    radar_engagement: '投入度', radar_landlord_rate: '地主欲', radar_win_rate: '準成度',
    radar_volatility: '奔放度', radar_attack: '進攻力', radar_defense: '防守力',
    ...
    round_trend_title: '得分走勢', round_trend_x_label: '局數',
    history_title: '歷史', history_search_placeholder: '搜索玩家...',
    history_loading: '加載中...', history_loaded_all: '已加載全部',
    ...
    settings_about_desc_prefix: '數據儲存於 ', settings_about_desc_suffix: '，支持離線記分',
    ...
    auth_login_title: 'FLL 鬥地主', auth_login_subtitle: '',
    auth_login_button: '登入', auth_logging_in: '登入中...',
    auth_logout: '登出', auth_logged_in_as: '已登入：',
    auth_relogin_settings: '重新登入', auth_relogin_settings_desc: '登出後重新進行身份驗證',
    auth_app_version: '版本',
  ...
  'zh-CN': {
    ...
    radar_volatility: '奔放度', radar_attack: '进攻力', radar_defense: '防守力',
    radar_games_unit: '局',
    round_trend_title: '得分走势', round_trend_x_label: '局数',
    history_title: '历史', history_search_placeholder: '搜索玩家...',
    history_loading: '加载中...', history_loaded_all: '已加载全部',
    ...
    settings_script_version: 'Apps Script 版本',
    settings_about_desc_prefix: '数据储存于 ', settings_about_desc_suffix: '，支持离线记分',
    ...
    auth_login_title: 'FLL 斗地主', auth_login_subtitle: '',
    auth_login_button: '登录', auth_logging_in: '登录中...',
    auth_logout: '登出', auth_logged_in_as: '已登录：',
    auth_relogin_settings: '重新登录', auth_relogin_settings_desc: '登出后重新进行身份验证',
    auth_app_version: '版本',
  ...
  'en': {
    ...
    score_select_short: '—', score_score_label: 'Score', score_latest_round: 'Latest', score_cancel: 'Cancel',
    ...
    radar_volatility: 'Boldness', radar_attack: 'Attack', radar_defense: 'Defense',
    radar_games_unit: ' games',
    round_trend_title: 'Score Trend', round_trend_x_label: 'Games',
    history_title: 'History', history_search_placeholder: 'Search player...',
    history_loading: 'Loading...', history_loaded_all: 'All loaded',
    ...
    settings_about_desc_prefix: 'Data stored in ', settings_about_desc_suffix: ', supports offline scoring',
    ...
    auth_login_title: 'FLL Doudizhu', auth_login_subtitle: '',
    auth_login_button: 'Sign In', auth_logging_in: 'Signing in...',
    auth_logout: 'Sign Out', auth_logged_in_as: 'Signed in as:',
    auth_relogin_settings: 'Re-authenticate', auth_relogin_settings_desc: 'Sign out and sign in again',
