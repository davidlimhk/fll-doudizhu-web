...
function renderHistoryList() {
  ...
  if (footerEl) {
    if (h.hasMore && AppState.isOnline) {
      ...
      // Offline: show hint that only loaded data is displayed
      footerEl.innerHTML = `<div class="history-footer" style="color:var(--warning)"><span class="material-icons" style="font-size:14px;vertical-align:-2px;margin-right:4px">cloud_off</span>${t('history_offline_loaded')} (${games.length} ${t('history_games_unit')})</div>`;
    } else {
...
// Inline Base64 WAV for mouse click (35ms, 3.1KB) - zero network latency
const _CLICK_WAV_B64 = '';
const _sfxFiles = {
