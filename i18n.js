...
const translations = {
  'zh-TW': {
    ...
    history_offline_cached: '離線模式 - 顯示緩存數據', history_offline_loaded: '離線模式 - 僅顯示已加載數據', history_this_round: '最新回合',
    ...
    auth_inapp_browser_title: '無法在此瀏覽器登入',
    auth_inapp_browser_msg: '請在 Safari 或 Chrome 中打開此頁面',
    auth_inapp_browser_copy: '複製連結',
    auth_inapp_browser_copied: '已複製！請在瀏覽器中貼上打開',
  ...
  'zh-CN': {
    ...
    history_offline_cached: '离线模式 - 显示缓存数据', history_offline_loaded: '离线模式 - 仅显示已加载数据', history_this_round: '最新回合',
    history_games_unit: '局', history_pending_label: '待同步',
    ...
    auth_inapp_browser_title: '无法在此浏览器登录',
    auth_inapp_browser_msg: '请在 Safari 或 Chrome 中打开此页面',
    auth_inapp_browser_copy: '复制链接',
    auth_inapp_browser_copied: '已复制！请在浏览器中粘贴打开',
  ...
  'en': {
    ...
    history_offline_cached: 'Offline - showing cached data', history_offline_loaded: 'Offline - showing loaded data only', history_this_round: 'Latest',
    ...
    auth_inapp_browser_title: 'Cannot sign in here',
    auth_inapp_browser_msg: 'Please open this page in Safari or Chrome',
    auth_inapp_browser_copy: 'Copy Link',
    auth_inapp_browser_copied: 'Copied! Paste in your browser to open',
